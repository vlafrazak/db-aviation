...
<form action="/~db/db-aviation/models/updateEmployees.php" method="post">
    ...
    <tr><td>First Name:</td><td> <input type="varchar" name="First_Name" value="<?php echo rtrim($_POST['First_Name'],'/'); ?>"/></td></tr>
    <tr><td>Surname:</td><td> <input type="varchar" name="Surname" value="<?php echo rtrim($_POST['Surname'],'/'); ?>"/></td></tr>
    <tr><td>Street Name:</td><td> <input type="varchar" name="Street_Name" value="<?php echo rtrim($_POST['Street_Name'],'/'); ?>"/></td></tr>
    <tr><td>Street Number:</td><td> <input type="int" name="Street_Number" value="<?php echo rtrim($_POST['Street_Number'],'/'); ?>"/></td></tr>
    <tr><td>Postal Code:</td><td> <input type="int" name="Postal_Code" value="<?php echo rtrim($_POST['Postal_Code'],'/'); ?>"/></td></tr>
