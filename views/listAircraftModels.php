...
<h4><th><a id='insert' href="/~db/db-aviation/views/createAircraftModels">INSERT</a></th></h4>
...
<?php
    ...
    foreach( $aircrafts as $aircraft ) {
        ...
        echo "<td><a href='/~db/db-aviation/views/listIsExpertIn.php?Model_Code=" . $aircraft[ 'Model_Code' ] ."&Model_Name=" . $aircraft[ 'Model_Name' ] . "'>" .  $aircraft[ 'Model_Name' ] . "</a></td>";
