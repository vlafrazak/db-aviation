...
<form action='/~db/db-aviation/models/insertEmail.php' method='POST'>
    ...
    <tr class="odd"><td>First Name:</td><td> <input type="text" name="First_Name" value="<?php echo $_GET[ 'First_Name' ]?>"/></td></tr>
    <tr class="even"><td>Surname:</td><td> <input type="text" name="Surname" value="<?php echo $_GET[ 'Surname' ]?>"/></td></tr>
