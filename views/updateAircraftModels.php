...
=======
    <tr class="even"><td>Model Code:</td><td> <input type="int" readonly="readonly" name="Model_Code" value="<?php echo rtrim($_POST['Model_Code'],'/'); ?>"/></td></tr>
    <tr class="odd"><td>Model Name:</td><td> <input type="text" name="Model_Name" value="<?php echo rtrim($_POST['Model_Name'],'/'); ?>"/></td></tr>
    <tr class="even"><td>Capacity:</td><td> <input type="int" name="Capacity" value="<?php echo rtrim($_POST['Capacity'],'/'); ?>"/></td></tr>
